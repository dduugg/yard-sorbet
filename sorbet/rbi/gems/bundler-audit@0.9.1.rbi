...
# source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:22
module Bundler::Audit; end

# Represents an advisory loaded from the {Database}.
#
# source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:38
class Bundler::Audit::Advisory < ::Struct
  ...
  # @return [Boolean]
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:210
  def ==(other); end
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:138
  def criticality; end
  ...
  # @return [String, nil]
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:93
  def cve_id; end
  ...
  # @since 0.7.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:113
  def ghsa_id; end
  ...
  # @since 0.7.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:124
  def identifiers; end
  ...
  # @return [String, nil]
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:102
  def osvdb_id; end
  ...
  # @since 0.2.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:184
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:219
  def to_h; end
  ...
  # @since 0.2.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:167
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:199
  ...
  class << self
    ...
    # @return [Advisory]
    #
    # source://bundler-audit-0.9.1/lib/bundler/audit/advisory.rb:50
    def load(path); end
  end
end
...
# and CVE number.
#
# source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:29
class Bundler::Audit::Database
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:62
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:262
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:285
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:309
  ...
  # @since 0.9.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:225
  def commit_id; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:181
  def git?; end
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:345
  def inspect; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:240
  ...
  # @return [String]
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:51
  def path; end
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:325
  def size; end
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:335
  def to_s; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:201
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:360
  ...
  # @yieldparam path [String] A path to an advisory `.yml` file.
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:376
  ...
  class << self
    ...
    # @since 0.8.0
    #
    # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:117
    ...
    # @since 0.8.0
    #
    # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:90
    ...
    #
    # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:76
    def path; end
    ...
    # @since 0.3.0
    #
    # source://bundler-audit-0.9.1/lib/bundler/audit/database.rb:158
    def update!(options = T.unsafe(nil)); end
  end
end
...
class Bundler::Audit::Task < ::Rake::TaskLib
  ...
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/task.rb:62
  def bundler_audit(*arguments); end

  # Defines the `bundle:audit` and `bundle:audit:update` task.
  #
  # source://bundler-audit-0.9.1/lib/bundler/audit/task.rb:24
  def define; end
end

# source://bundler-audit-0.9.1/lib/bundler/audit/task.rb:9
class Bundler::Audit::Task::CommandNotFound < ::RuntimeError; end

# bundler-audit version
#
# source://bundler-audit-0.9.1/lib/bundler/audit/version.rb:21
